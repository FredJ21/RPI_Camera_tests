...
def my_argparse():
    ...
    *******************************************
    ...
    Exemples d'utilisation :
        ...
        python camera.py -video exemples/video_captcha_60s.mp4 -yolo exemples/20250221_captcha_detect.pt

        python camera.py -cam 0 -yolo exemples/20250221_captcha_detect.pt
